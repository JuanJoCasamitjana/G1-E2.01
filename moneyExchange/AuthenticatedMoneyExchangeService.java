...
@Service
public class AuthenticatedMoneyExchangeService implements AbstractPerformService<Authenticated, MoneyExchange>{
	...
	public void perform(final Request<MoneyExchange> request, final MoneyExchange entity, final Errors errors) {
		...
		if (exchange == null) {
			...
			MoneyExchangeTracking tracker;
			tracker = new MoneyExchangeTracking();
			
			tracker.setExchange(exchange);
