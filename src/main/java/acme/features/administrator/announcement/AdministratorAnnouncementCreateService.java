...
//		errors.state(request, !bodyHasTooMuchSpam, "body", "administrator.announcement.form.error.spam");
//		errors.state(request, !titleHasTooMuchSpam, "title", "administrator.announcement.form.error.spam");
