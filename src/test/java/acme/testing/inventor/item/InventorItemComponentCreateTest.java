...
public class InventorItemComponentCreateTest extends TestHarness {
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/inventor/item/create-positive-component.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(10)
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/inventor/item/create-negative-component.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(10)
