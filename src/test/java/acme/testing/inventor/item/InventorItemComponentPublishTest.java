...
public class InventorItemComponentPublishTest extends TestHarness {
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/inventor/item/publish-positive-component.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(10)
